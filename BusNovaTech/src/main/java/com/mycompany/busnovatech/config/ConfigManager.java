 ...
 */
    ...
    public Configuracion cargarConfig() throws Exception {
        ...
        // Siempre pedir cantidad de buses del día
    ...
    public Configuracion crearTerminal() throws Exception {
        // Llama al método privado para poder usarse en el menu - Mario.
        return crearConfigInicial();
    }
}
